({ 
    doInIt: function(component, event, helper) {
        ...
        var columns = [
            {'label': 'Location Name', 'fieldName': 'Name', 'type': 'text', 'sortable' : true,'initialWidth':150},
            {'label': 'Service Resource', 'fieldName': 'Service_Resource__c', 'type': 'text', 'sortable' : true,'initialWidth':150},
            {'label': 'City','fieldName': 'FS_City__c', 'type': 'text', 'sortable' : true,'initialWidth':150},
            {'label': 'State','fieldName': 'FS_State__c', 'type': 'text', 'sortable' : true,'initialWidth':150},
            {'label': 'Country','fieldName': 'FS_Country__c', 'type': 'text', 'sortable' : true,'initialWidth':150}
        ]; 
